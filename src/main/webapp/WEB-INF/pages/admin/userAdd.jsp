...
<head>
    ...
    <link rel="stylesheet" href="/statc/lib/bootstrap/css/bootstrap.css" >
    <link rel="stylesheet" href="/statc/css/index.css">
    <link rel="stylesheet" href="/statc/css/header.css">
    <link rel="stylesheet" href="/statc/css/footer.css">
    <link rel="stylesheet" href="/statc/css/personInfo.css">
        ...
        <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1 personInfo-form">
            <form>
                ...
                <div class="list-inline" >
                    ...
                    <label><input name="userType" type="radio" value="1"/> 管理员 </label>
                </div>
